...
def add_simulator_parser(subparsers):
...
""" 
    ...
    simulator_parser.add_argument(
        "--output",
        required=False,
        help="Output directory for the simulation results. If not provided, defaults to silosim_simulator_output_<YYYY_MM_DD_HHMMSS> under the current working directory."
    )
