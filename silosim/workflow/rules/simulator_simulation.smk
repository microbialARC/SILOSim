rule simulator_simulation:
    ...
    output:
        stats = os.path.join(config["output"], "simulator", "output", "stats.txt"),
        mutations = os.path.join(config["output"], "simulator", "output", "mutations.csv"),
        weight_mutation = os.path.join(config["output"], "simulator", "intermediate", "weight_mutation.csv") if config["use_weighted_mutation"] else [],
